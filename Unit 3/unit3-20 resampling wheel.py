# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 23:09:02 2013
...
# find the biggest weight first
w_max = max(w)

index = 0 # index start from zero to 999
beta = 0
# starting resampling wheel
for i in range(N):
    ...
    while w[index] < beta:
        ...
        index +=1
        if index > 999:
            index = 0   # set index back to zero (wheel)
    p3.append(p[index])
