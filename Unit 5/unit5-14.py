...
def run(param1, param2, param3):
    ...
    N = 100
    myrobot.set_steering_drift(
        10.0 / 180.0 * pi)  # 10 degree bias, this will be added in by the move function, you do not need to add it below!
    #
    # Enter code here
    #
    ...
    for i in xrange(N):
        cte = cteT = myrobot.y
        diff_cte = (cteT - cteT1) / speed
        steering = - param1 * cte \
                   - param2 * diff_cte \
                   - param3 * int_cte
        # update cte(t-1) and integral cte
        cteT1 = cteT
        int_cte += cteT
